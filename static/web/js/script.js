$(function () {
	...
	function inlineCSS() {
		$(".home-slider .item").each(function () {
			...
			var attrMobileImage = $(this).attr('data-mobile-image');
			var attrColorBG = $(this).attr('data-background-color');

			if (attrMobileImage !== undefined && window.innerWidth <= 768) {
				$(this).css('background-image', 'url(' + attrMobileImage + ')');
			} else if (attrImageBG !== undefined) {
			...
			$.ajax({
				...
				success: function (data) {
					...
					if (status) {
						...
						// Use the promise to execute actions after the Snackbar duration
						delay(1000).then(function () {
							...
							if (reset) {
								// Assuming you have a function named window.location.reset()
